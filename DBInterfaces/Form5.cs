    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (ValidateChildren(ValidationConstraints.Enabled))
            {
                ...
                {
                    int count = db.Database.ExecuteSqlRaw("INSERT INTO ActiveSubstInDrugs VALUES ({0}, {1}, {2})", int.Parse(textBox1.Text), int.Parse(textBox2.Text), int.Parse(textBox3.Text));
                }
                Close();
            }
        }
